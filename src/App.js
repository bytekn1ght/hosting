...
class App extends React.Component {
        ...
        render() {
            let barsDiv = this.state.array.map((value, index) => < Bar key = {
                    index
                }
                length = {
                    value
                ...
                if (this.state.timeouts.length !== 0 && this.state.currentStep !== this.state.arraySteps.length) {
                    ...
                    <
                    Form formLabel = "Array size"
                    values = {
                        [10, 25, 50, 100]
                    }
                    labels = {
                        ['10 items', '25 items', '50 items', '100 items']
                    }
                    currentValue = {
                        this.state.barCount
                    }
                    onChange = {
                        e => this.changeBarCount(e.target.value)
                    }
                    />
